...
{
    public partial class AddDisposalRecord
    {
        [Inject]
        ...
        {
            disposalRecord = new ActivosFiljos.Server.Models.FixedAssetsDB.DisposalRecord();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.CreateDisposalRecord(disposalRecord);
