...
{
    public partial class AddScheduledMaintenance
    {
        [Inject]
        ...
        {
            scheduledMaintenance = new ActivosFiljos.Server.Models.FixedAssetsDB.ScheduledMaintenance();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.CreateScheduledMaintenance(scheduledMaintenance);
