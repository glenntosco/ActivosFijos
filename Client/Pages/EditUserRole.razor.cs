...
namespace ActivosFiljos.Client.Pages
{
    public partial class EditUserRole
    {
        ...
        {
            userRole = await FixedAssetsDBService.GetUserRoleByUserRoleId(userRoleId:UserRoleId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.UpdateUserRole(userRoleId:UserRoleId, userRole);
