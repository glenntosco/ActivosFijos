...
{
    public partial class EditMaintenanceRecord
    {
        [Inject]
        ...
        {
            maintenanceRecord = await FixedAssetsDBService.GetMaintenanceRecordByMaintenanceId(maintenanceId:MaintenanceId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.UpdateMaintenanceRecord(maintenanceId:MaintenanceId, maintenanceRecord);
