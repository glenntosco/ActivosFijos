...
{
    public partial class EditAssetAttributeValue
    {
        [Inject]
        ...
        {
            assetAttributeValue = await FixedAssetsDBService.GetAssetAttributeValueByAttributeValueId(attributeValueId:AttributeValueId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.UpdateAssetAttributeValue(attributeValueId:AttributeValueId, assetAttributeValue);
