...
{
    public partial class AddFixedAsset
    {
        [Inject]
        ...
        {
            fixedAsset = new ActivosFiljos.Server.Models.FixedAssetsDB.FixedAsset();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.CreateFixedAsset(fixedAsset);
