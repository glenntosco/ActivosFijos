...
namespace ActivosFiljos.Client.Pages
{
    public partial class EditDocument
    {
        ...
        {
            document = await FixedAssetsDBService.GetDocumentByDocumentId(documentId:DocumentId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.UpdateDocument(documentId:DocumentId, document);
