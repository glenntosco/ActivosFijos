...
{
    public partial class AddAssetAssignment
    {
        [Inject]
        ...
        {
            assetAssignment = new ActivosFiljos.Server.Models.FixedAssetsDB.AssetAssignment();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.CreateAssetAssignment(assetAssignment);
