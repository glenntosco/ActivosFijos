...
{
    public partial class AddDepreciation
    {
        [Inject]
        ...
        {
            depreciation = new ActivosFiljos.Server.Models.FixedAssetsDB.Depreciation();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.CreateDepreciation(depreciation);
