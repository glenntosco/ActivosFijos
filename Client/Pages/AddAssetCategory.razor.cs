...
{
    public partial class AddAssetCategory
    {
        [Inject]
        ...
        {
            assetCategory = new ActivosFiljos.Server.Models.FixedAssetsDB.AssetCategory();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.CreateAssetCategory(assetCategory);
