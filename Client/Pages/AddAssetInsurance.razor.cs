...
{
    public partial class AddAssetInsurance
    {
        [Inject]
        ...
        {
            assetInsurance = new ActivosFiljos.Server.Models.FixedAssetsDB.AssetInsurance();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FixedAssetsDBService.CreateAssetInsurance(assetInsurance);
