...
namespace ActivosFiljos.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<ActivosFiljos.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(ActivosFiljos.Server.Models.ApplicationRole role)
        {
            try
            {
