...
namespace ActivosFiljos.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<ActivosFiljos.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<ActivosFiljos.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(ActivosFiljos.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(ActivosFiljos.Server.Models.ApplicationUser user)
        {
            try
            {
